...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        'h-screen px-4 py-4 hidden md:flex md:flex-col bg-neutral-100 dark:bg-neutral-800 w-64 flex-shrink-0 fixed left-0 top-0 z-40',
        className
      )}
      animate={{
...
export const MobileSidebar = ({ className, children, ...props }: React.ComponentProps<'div'>) => {
  ...
  return (
    <>
      <div
        className={cn(
          'h-14 px-4 py-3 flex flex-row md:hidden items-center justify-between bg-neutral-100 dark:bg-neutral-800 w-full fixed top-0 left-0 z-50'
        )}
        {...props}
      >
...
export const SidebarLink = ({
  ...
  // If a custom component is provided, render it with the icon
  if (link.component) {
    return (
      <div
