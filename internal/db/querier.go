...
type Querier interface {
	...
	GetSubscriptionWithWorkspace(ctx context.Context, arg GetSubscriptionWithWorkspaceParams) (GetSubscriptionWithWorkspaceRow, error)
	...
	ListSubscriptionsByProduct(ctx context.Context, arg ListSubscriptionsByProductParams) ([]ListSubscriptionsByProductRow, error)
