...
const createSubscriptionWithSync = `-- name: CreateSubscriptionWithSync :one
INSERT INTO subscriptions (
    customer_id,
    product_id,
    workspace_id,
...
func (q *Queries) CreateSubscriptionWithSync(ctx context.Context, arg CreateSubscriptionWithSyncParams) (Subscription, error) {
	row := q.db.QueryRow(ctx, createSubscriptionWithSync,
		arg.CustomerID,
		arg.ProductID,
		arg.WorkspaceID,
		arg.ProductTokenID,
...
SELECT id, num_id, customer_id, product_id, workspace_id, product_token_id, external_id, token_amount, delegation_id, customer_wallet_id, status, current_period_start, current_period_end, next_redemption_date, total_redemptions, total_amount_in_cents, metadata, payment_sync_status, payment_synced_at, payment_sync_version, payment_provider, created_at, updated_at, deleted_at, currency, cancel_at, cancelled_at, cancellation_reason, paused_at, pause_ends_at, trial_start, trial_end FROM subscriptions
WHERE 
...
func (q *Queries) GetSubscriptionByExternalID(ctx context.Context, arg GetSubscriptionByExternalIDParams) (Subscription, error) {
	row := q.db.QueryRow(ctx, getSubscriptionByExternalID, arg.WorkspaceID, arg.ExternalID, arg.PaymentProvider)
	var i Subscription
	err := row.Scan(
		&i.ID,
		&i.NumID,
...
func (q *Queries) GetSubscriptionByNumID(ctx context.Context, numID int64) (Subscription, error) {
	row := q.db.QueryRow(ctx, getSubscriptionByNumID, numID)
	var i Subscription
	err := row.Scan(
		&i.ID,
		&i.NumID,
...
type GetSubscriptionWithDetailsRow struct {
	...
	CustomerNumID              int64              `json:"customer_num_id"`
	CustomerName               pgtype.Text        `json:"customer_name"`
	CustomerEmail              pgtype.Text        `json:"customer_email"`
	CustomerPhone              pgtype.Text        `json:"customer_phone"`
	CustomerDescription        pgtype.Text        `json:"customer_description"`
	CustomerFinishedOnboarding pgtype.Bool        `json:"customer_finished_onboarding"`
	CustomerMetadata           []byte             `json:"customer_metadata"`
...
SELECT id, num_id, customer_id, product_id, workspace_id, product_token_id, external_id, token_amount, delegation_id, customer_wallet_id, status, current_period_start, current_period_end, next_redemption_date, total_redemptions, total_amount_in_cents, metadata, payment_sync_status, payment_synced_at, payment_sync_version, payment_provider, created_at, updated_at, deleted_at, currency, cancel_at, cancelled_at, cancellation_reason, paused_at, pause_ends_at, trial_start, trial_end FROM subscriptions s
...
func (q *Queries) GetSubscriptionWithWorkspace(ctx context.Context, arg GetSubscriptionWithWorkspaceParams) (Subscription, error) {
...
func (q *Queries) GetSubscriptionsNeedingSync(ctx context.Context, workspaceID uuid.UUID) ([]Subscription, error) {
	rows, err := q.db.Query(ctx, getSubscriptionsNeedingSync, workspaceID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type GetSubscriptionsSyncedByProviderParams struct {
	WorkspaceID     uuid.UUID   `json:"workspace_id"`
	PaymentProvider pgtype.Text `json:"payment_provider"`
}

func (q *Queries) GetSubscriptionsSyncedByProvider(ctx context.Context, arg GetSubscriptionsSyncedByProviderParams) ([]Subscription, error) {
	rows, err := q.db.Query(ctx, getSubscriptionsSyncedByProvider, arg.WorkspaceID, arg.PaymentProvider)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetSubscriptionsWithSyncConflicts(ctx context.Context, workspaceID uuid.UUID) ([]Subscription, error) {
	rows, err := q.db.Query(ctx, getSubscriptionsWithSyncConflicts, workspaceID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ListSubscriptionDetailsWithPaginationRow struct {
	...
	SubscriptionNumID              int64              `json:"subscription_num_id"`
...
type ListSubscriptionsDueForRedemptionRow struct {
	ID                 uuid.UUID          `json:"id"`
	CustomerID         uuid.UUID          `json:"customer_id"`
	ProductID          uuid.UUID          `json:"product_id"`
	ProductTokenID     uuid.UUID          `json:"product_token_id"`
...
func (q *Queries) ListSubscriptionsDueForRedemption(ctx context.Context, nextRedemptionDate pgtype.Timestamptz) ([]ListSubscriptionsDueForRedemptionRow, error) {
	rows, err := q.db.Query(ctx, listSubscriptionsDueForRedemption, nextRedemptionDate)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListSubscriptionsDueForRedemptionRow{}
	for rows.Next() {
		var i ListSubscriptionsDueForRedemptionRow
		if err := rows.Scan(
			&i.ID,
			&i.CustomerID,
			&i.ProductID,
...
const updateSubscriptionPaymentSyncStatus = `-- name: UpdateSubscriptionPaymentSyncStatus :one
UPDATE subscriptions 
...
func (q *Queries) UpdateSubscriptionPaymentSyncStatus(ctx context.Context, arg UpdateSubscriptionPaymentSyncStatusParams) (Subscription, error) {
	row := q.db.QueryRow(ctx, updateSubscriptionPaymentSyncStatus,
		arg.ID,
		arg.WorkspaceID,
		arg.PaymentSyncStatus,
		arg.PaymentProvider,
...
const updateSubscriptionWithSync = `-- name: UpdateSubscriptionWithSync :one
UPDATE subscriptions
SET
    customer_id = COALESCE($2, customer_id),
    product_id = COALESCE($3, product_id),
...
func (q *Queries) UpdateSubscriptionWithSync(ctx context.Context, arg UpdateSubscriptionWithSyncParams) (Subscription, error) {
	row := q.db.QueryRow(ctx, updateSubscriptionWithSync,
		arg.ID,
		arg.CustomerID,
		arg.ProductID,
		arg.WorkspaceID,
